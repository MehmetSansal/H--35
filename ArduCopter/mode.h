...
public:
	...
	STM =          27,  // Stm yarismasi icin yazilmis moddur
    };
...
protected:
    ...
    const char *name4() const override { return "ST"; }


private:
    void set_desired_velocity_with_accel_limits(const Vector3f& vel_des);
    void circle_with_velocity();
    void two_meter();
    bool two_meter_check();
    void cross_with_yaw();
    void five_meters_with_yaw();
    void hover();
    bool two_meter_check_ns();
    void circle_with_position();
    float angle(float a,float b);
    void circle_with_position_time();
};
